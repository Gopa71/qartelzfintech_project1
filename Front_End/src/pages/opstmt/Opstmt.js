...
function Opstmt() {
  ...
  return (
    <div>
      ...
      >
        <div className="mt-10  container-fluid  d-flex justify-content-center border-1 border-black rounded-3xl div_1">
        ...
        <div className="container-fluid border-1 border-black mt-3">
          <div className="row">
            <div className="col-lg-4 border-end border-black   d-flex justify-content-center ">
              <h5 className="p-1 text-bold text-xl"> Operating Statement</h5>
            </div>
            <div className="col-lg-8 border-start d-flex justify-content-center">
              <h5 className="p-1 text-xl text-bold">
        ...
        >
          <div className={" container-fluid border-1 border-black "}>
            <div className="row">
              <div className="col-lg-4 border-end border-black   flex align-items-center  justify-content-center">
                <h6 className="text-center  ">PARTICULARS</h6>
              </div>
               ...
               {/* <div className="dropdown-menu">
                ...
                {isOpen && (
                  <ul className="dropdown-list">
                    <li><a href="#" onClick={() => handleItemClick('Subheading 1')}>Subheading 1</a></li>
                    <li><a href="#" onClick={() => handleItemClick('Subheading 2')}>Subheading 2</a></li>
                    <li><a href="#" onClick={() => handleItemClick('Subheading 3')}>Subheading 3</a></li>
                  </ul>
                )}
        ...
        <div className="container-fluid border-1 border-black mt-3">
          ...
          >
            <div className="col-lg-4 border-end border-black   d-flex items-center justify-content-center">
              <h5 className="text-center p-2">NET SALES</h5>
            </div>
          </div>
        </div>
        <div className="container-fluid border-1 border-black mt-3">
        ...
        <div className="container-fluid border-1 border-black mt-3">
          ...
          <div className="row border-end border-black   border-top">
            ...
            <div className="col-lg-1 border-start d-flex justify-content-center">
              <div className="row g-3">
                <div className="col">
                  <input
                    style={{
                      backgroundColor: "rgb(238, 193, 255)",
                      fontWeight: "bold",
                    }}
                    type="text"
                    className="form-control"
            ...
            <div className="col-lg-1 border-start d-flex justify-content-center">
              <div className="row g-3">
                <div className="col">
                  <input
                    style={{
                      backgroundColor: "rgb(246, 230, 178)",
                      fontWeight: "bold",
                    }}
                    type="text"
                    className="form-control"
            ...
            <div className="col-lg-1 border-start d-flex justify-content-center">
              <div className="row g-3">
                <div className="col">
                  <input
                    style={{
                      backgroundColor: "rgb(188, 245, 185)",
                      fontWeight: "bold",
                    }}
                    type="text"
                    className="form-control"
            ...
            <div className="col-lg-1 border-start d-flex justify-content-center">
              <div className="row g-3">
                <div className="col">
                  <input
                    style={{
                      backgroundColor: "rgb(247, 197, 237)",
                      fontWeight: "bold",
                    }}
                    type="text"
                    className="form-control"
